...
export const footerLinks = [
  {
    ...
    links: [
      ...
      { text: "Erbjudanden", url: "#" },
      { text: "Kontakta oss", url: "#" },
      { text: "Vanliga frågor", url: "#" },
      { text: "Bli säljare", url: "/seller" },
    ],
  },
  {
    title: "Behöver du hjälp?", 
    links: [
      { text: "Leveransinformation", url: "#" },
      { text: "Retur- och återbetalningspolicy", url: "#" },
      { text: "Betalningsmetoder", url: "#" },
      { text: "Spåra din order", url: "#" },
      { text: "Kontakta oss", url: "#" },
    ],
  },
  {
